...
class DadosPaciente(models.Model):
    ...
    colesterol_hdl = models.IntegerField(blank=True)
    colesterol_ldl = models.IntegerField(blank=True)
    colesterol_total = models.IntegerField(blank=True)
    trigliceridios = models.IntegerField(blank=True)
